...
export const PlaylistItem = ({ playlistItem, selectVideoHandler }) => {

    return (
        <Loader loaded={!!playlistItem} width={2} lines={12} length={8} color={'#fff'} opacity={0.2} className={'loading'}>
            <div className={playlistItemClass} onClick={() => selectVideoHandler(playlistItem.contentDetails.videoId)}>
